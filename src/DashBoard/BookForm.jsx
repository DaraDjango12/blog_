...
const BookForm = () => {
  ...
  const { bookTitle,bookAuthor,bookPrice,bookISBN,bookLink,category,id:uuidv4 } = formData;
  ...
  const submitHandler = () => {
    ...
    const data = { bookTitle,bookAuthor,bookPrice,bookISBN,bookLink,category};
  ...
  return (
    <div className='w-50vw h-100vh  flex justify-center '>
             ...
             <div className='mt-4'>
                <label>Image</label>
                <input type="text" name="bookLink" value={formData.bookLink} onChange={onChangeHandler} />
                </div>

             <div className='mt-4'>
                <label>Book Title</label>
                <input type="text" name='bookTitle' onChange={onChangeHandler} value={formData.bookTitle}/>
            </div>
             <div className='mt-4'>
                <label>Category</label>
                <input type="text" name='bookCategory' onChange={onChangeHandler} value={formData.category}/>
            </div>
             <div className='mt-4'>
                <label>Author  :</label>
                <input type="text" name="bookAuthor" value={formData.bookAuthor} onChange={onChangeHandler}/>
             </div>
             <div className='mt-4'>
                <label>Book ISBN ;</label>
                <input type="text" name="bookISBN"value={formData.bookISBN} onChange={onChangeHandler}/>
            </div>
             <div className='mt-4'>
                <p>Price :</p>
                <input type="text" name="bookPrice" value={formData.bookPrice} onChange={onChangeHandler}/>
             </div>
